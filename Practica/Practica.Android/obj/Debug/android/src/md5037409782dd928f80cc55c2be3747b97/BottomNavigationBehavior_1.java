...
public class BottomNavigationBehavior_1
	extends md5037409782dd928f80cc55c2be3747b97.VerticalScrollingBehavior_1
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BottomNavigationBar.Scrollswetness.BottomNavigationBehavior`1, BottomNavigationBar, Version=1.4.0.2, Culture=neutral, PublicKeyToken=null", BottomNavigationBehavior_1.class, __md_methods);
	}
	...
	public BottomNavigationBehavior_1 ()
	{
		...
		if (getClass () == BottomNavigationBehavior_1.class)
			mono.android.TypeManager.Activate ("BottomNavigationBar.Scrollswetness.BottomNavigationBehavior`1, BottomNavigationBar, Version=1.4.0.2, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public BottomNavigationBehavior_1 (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == BottomNavigationBehavior_1.class)
			mono.android.TypeManager.Activate ("BottomNavigationBar.Scrollswetness.BottomNavigationBehavior`1, BottomNavigationBar, Version=1.4.0.2, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}
